...
rius_cat <- read.csv("data/raw/TAULA_Catalunya.csv")
...
analisis_cat <- analitzar_csv(rius_cat)
processar_cat <- processar_csv(rius_cat,analisis_cat$RIUS_AMB_NOM)


analisis_cat$RIUS_AMB_NOM
analisis_cat$RIUS_SENSE_NOM
analisis_cat$RIUS_TOTS
